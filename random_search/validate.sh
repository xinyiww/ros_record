...
ROSBAG=t_jun_pred_combo_gap_filtered.bag # should not contain /region/lanes_prediction and /region/all_cars_predictions_idm
# working space
WS=/home/xliu/Documents/ros_record/random_search/


# define GT
python generate_random_sets.py $CSV_FILE $WS
